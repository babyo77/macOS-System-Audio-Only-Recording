...
document.getElementById("selected-folder-path").textContent =
  selectedFolderPath;
...
document
  .getElementById("recording-filename")
...
document.getElementById("start-recording").addEventListener("click", () => {
  ...
  const trimmedFilename = filenameInput.value.trim();
  if (!trimmedFilename) {
    alert("Please enter a recording filename.");
    return;
  }
  recordingFilename = trimmedFilename;
